...
## Проблема
При попытке войти в админ-панель с учетными данными по умолчанию появляется ошибка "Неверные учетные данные", даже после сброса пароля.
...
Запустите скрипт проверки логина администратора:
